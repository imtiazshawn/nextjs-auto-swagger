...
exports.createSwaggerHandler = createSwaggerHandler;
const path = __importStar(require("path"));
const scanner_1 = require("../scanner");
const generator_1 = require("../generator");
function createSwaggerHandler(config = {}) {
    return {
        async GET(request) {
            ...
            if (isJsonRequest) {
                try {
                    ...
                    const scanner = new scanner_1.APIRouteScanner(appDir, config);
                    const routes = await scanner.scanRoutes();
                    const generator = new generator_1.OpenAPIGenerator(config);
